...
DEFAULTS: ConfigShape = {
    ...
    "check_updates": True,
    # Типово переливчаста — за словом людини. Колір за станом лишається
    # доступним вимикачем: він несе зміст (іде / стоїть / не зараховується),
    # і кому важливіший зміст за красу, вимикає перелив однією галочкою.
