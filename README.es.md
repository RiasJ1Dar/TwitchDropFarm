...
![Arquitectura](docs/architecture.en.png)

Diagrama interactivo: [abrir en el navegador](https://riasj1dar.github.io/TwitchDropFarm/architecture.en.html) (en GitHub se ve el código, no la página).
