...
Кросплатформно через pystray: `pywin32` потрібен лише на Windows (сповіщення).
На Linux для меню в панелі часто потрібен AppIndicator — див.
`docs/autostart-linux-macos.md`.
